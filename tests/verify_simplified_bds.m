...
try
    ...
    % DEVGLA1 evaluates a noninteger power of its second variable. Polling can
    % make that variable negative, producing complex objective values outside
    % the real-valued solver contract and platform-dependent comparison paths.
    blacklist = ["DEVGLA1",...
        "DIAMON2DLS",...
        "DIAMON2D",...
        "DIAMON3DLS",...
