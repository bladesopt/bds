...
function x = accelerated_auto_stopping_profile_test(fun, x0, ...
    ...
    if nargin < 12
        grad_reference_relative_tol = 1e-3 * grad_tol;
    end
...
function [matched, func_window_size, func_tol, grad_window_size, grad_tol, ...
        ...
        use_gradient_reference_consistency, ...
        grad_reference_finite_difference_error_tol, grad_reference_relative_tol] = ...
    ...
    if ~matched
        ...
        grad_reference_relative_tol = NaN;
        return
    end
    ...
    if isempty(grs_tokens)
        ...
        grad_reference_relative_tol = str2double( ...
            strrep(grs_tokens{1}, 'p', '.')) * grad_tol;
    end
