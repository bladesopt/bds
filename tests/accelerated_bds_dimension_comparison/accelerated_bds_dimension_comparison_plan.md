...
| --- | --- | --- | --- |
| `Original BDS` | `src/bds.m` | `cbds-200n` | `Algorithm = 'cbds'`, `MaxFunctionEvaluations = 200n`, `StepTolerance = 1e-6` |
| `Accelerated BDS` | `tests/competitors/accelerated_bds_options.m` | `accelerated-bds-all-on-200n` | `Algorithm = 'cbds'`, all three acceleration switches enabled, `MaxFunctionEvaluations = 200n`, `StepTolerance = 1e-6` |
...
- Raw data location: `tests/testdata`
- Merged pairwise summaries: `tests/accelerated_bds_dimension_comparison/summaries`
