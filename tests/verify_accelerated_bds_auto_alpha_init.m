function verify_accelerated_bds_auto_alpha_init()
%VERIFY_ACCELERATED_BDS_AUTO_ALPHA_INIT Check the public automatic-step path.
...
fprintf('ACCELERATED_BDS_AUTO_ALPHA_INIT_OK\n');
clear cleanup
...
options.use_sweep_pattern_direction = use_acceleration;
...
[result.x, result.f, result.exitflag, result.output] = ...
    accelerated_bds_options(@focused_objective, x0, options);
