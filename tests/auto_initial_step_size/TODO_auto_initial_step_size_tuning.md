...
- solver：`tests/competitors/accelerated_bds_options.m`；
- `Algorithm = "cbds"`；
...
```text
tests/auto_initial_step_size/run_auto_initial_step_size_500n_full_factorial.m
tests/auto_initial_step_size/run_auto_initial_step_size_500n_full_factorial_screen.sh
```
